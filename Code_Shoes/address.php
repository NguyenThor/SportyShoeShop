                ...
                <div class="row">
                    ...
                    <div class="row" >
                        <div class="col-md-5 col-sm-5">
                            ...
                            <form action="address-save.php" method="post">

                                <div class="">
                                    <div class="form-name">
                                        <label for="DCNH_TEN" class="form-label"> Tên người nhận <em>*</em> </label>
                                ...
                                <div class="">
                                    <div class="form-name">
                                        <label for="DCNH_SDT" class="form-label"> Số điện thoại người nhận <em>*</em> </label>
                                ...
                                <div class="">
                                    <div class="">
                                        <label> Tỉnh/Thành phố <em style="color:red;">*</em> </label>
                                ...
                                <div class="">
                                    <div class="">
                                        <label>Địa chỉ cụ thể <em style="color:red;">*</em> (đường/số nhà/căn hộ/tòa nhà/...) </label>
                                        <input id="DCNH_DIACHI" name="DCNH_DIACHI" type="text" class="form-control">                                        </select>
                                    </div>
                                </div><br>

                                <button class="btn btn-danger" type="submit">Thêm địa chỉ mới</button>
                        ...
                        <?php
                            ...
                            $ND_ID = $_COOKIE['ND_ID'];
                            $sql = "select * from diachinhanhang where ND_ID = '$ND_ID'";
                    ...
                    ?>
                            ...
                            <?php foreach ($data as $row) : ?>    
                                <table class="table table-success table-striped">
                                    <div class="pay-info" style="back">
                                        <div class="col col-lg-1">
                                            <i style="color:red; font-size:20px;margin-left:30px; "class="fa-solid fa-location-dot"></i>
                                        </div>   
                                        <div class="col col-lg-11">
                                            <div class="main__pay-text" style="color:black;">
                                                <b><?php echo $row['DCNH_TEN']; ?></b> | <?php echo $row['DCNH_SDT']; ?> <br>
                                                <?php echo $row['DCNH_DIACHI']; ?>, <?php echo $row['DCNH_XA']; ?>, <?php echo $row['DCNH_HUYEN']; ?>, 
                                                <?php echo $row['DCNH_TINH']; ?>.
                                                <br>                                                
                                                <a href="cart1.php?DCNH_MA=<?php echo $row['DCNH_MA'];?>" class="btn btn-primary" href="address-select.php?DCNH_MA=<?php echo $row['DCNH_MA'];?>">Chọn</a> 
                                                <a class="btn btn-danger" href="address-delete.php?DCNH_MA=<?php echo $row['DCNH_MA'];?>">Xóa</a>
                                            </div>
                                        </div>                                
                                    </div>
                                </table>                                                           
