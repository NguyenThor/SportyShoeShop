                        ...
                        <?php foreach ($data as $row) : ?>
                          <tr>
                              ...
                              <td style="font-size:20px;">
                                <a href="brand_edit.php?TH_ID=<?php echo $row['TH_ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                 &nbsp;&nbsp;
                                <a  href="brand_delete.php?TH_ID=<?php echo $row['TH_ID'] ?>" style="color:rgb(211, 21, 21);"><i class="fa-solid fa-trash-can"></i></a>
                              </td>
                          </tr>                         
                        <?php endforeach; ?>
                    </tbody>
