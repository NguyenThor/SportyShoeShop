            ...
            <div class="row">
              <div class="col-12">
                ...
                <?php
                    ...
                    $TH_ID = $_GET['TH_ID'];
                    $sqlSelect = "select * from `thuonghieu` where TH_ID = '$TH_ID' ";
                ...
                <form action="brand_edit1.php" name="frmCreate" method="post"  class="form">
                                                        <table class="table table-light">
                                                            <tr>
                                                                <td>Tên thương hiệu</td>
                                                                <input type="hidden" name="TH_ID" id="TH_ID" class="form-control" value="<?php echo $Row['TH_ID'] ?>" />
                                                                <td><input type="text" name="TH_TEN" id="TH_TEN" class="form-control" value="<?php echo $Row['TH_TEN'] ?>" /></td>
                                                            </tr>                                                            
                                                        </table>
                                                        <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button> &nbsp;&nbsp;
