          ...
          <div class="title-wrapper pt-30">
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title d-flex align-items-center flex-wrap">
                  <h2 class="mr-40">Màu sắc sản phẩm</h2>
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">               
                                                ...
                                                <form name="frmCreate" method="post" action="color_add.php" class="form">
                                                        <table class="table table-light">
                                                            <tr>
                                                                <td>Tên màu sắc</td>
                                                                <td><input type="text" name="MS_TEN" id="MS_TEN" class="form-control" /></td>
                                                            </tr>                                                            
                                                        </table>
                        ...
                        <?php foreach ($data as $row) : ?>
                          <tr>
                              ...
                              <td style="font-size:20px;">
                                <a href="color_edit.php?MS_ID=<?php echo $row['MS_ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                 &nbsp;&nbsp;
                                <a  href="color_delete.php?MS_ID=<?php echo $row['MS_ID'] ?>" style="color:rgb(211, 21, 21);"><i class="fa-solid fa-trash-can"></i></a>
                              </td>
                          </tr>                         
                        <?php endforeach; ?>
                    </tbody>
