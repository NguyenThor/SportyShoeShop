          ...
          <div class="title-wrapper pt-30">
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">               
                                                ...
                                                <form name="frmCreate" method="post" action="brand_add.php" class="form">
                                                        <table class="table table-light">
                                                            <tr>
                                                                <td>Tên màu sắc</td>
                                                                <td><input type="text" name="TH_TEN" id="TH_TEN" class="form-control" /></td>
                                                            </tr>                                                            
                                                        </table>
            ...
            <div class="row">
              <div class="col-12">
                ...
                <?php
                    ...
                    $MS_ID = $_GET['MS_ID'];
                    $sqlSelect = "select * from `mausac` where MS_ID = '$MS_ID' ";
                ...
                <form action="color_edit1.php" name="frmCreate" method="post"  class="form">
                                                        <table class="table table-light">
                                                            <tr>
                                                                <td>Tên màu sắc</td>
                                                                <input type="hidden" name="MS_ID" id="MS_ID" class="form-control" value="<?php echo $Row['MS_ID'] ?>" />
                                                                <td><input type="text" name="MS_TEN" id="MS_TEN" class="form-control" value="<?php echo $Row['MS_TEN'] ?>" /></td>
                                                            </tr>                                                            
                                                        </table>
                                                        <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button> &nbsp;&nbsp;
