                ...
                <?php                
                                                                          ...
                                                                          while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                                                                              $data[] = array(                                                                                   
                                                                                  ...
                                                                                  'DH_TONGTIENHANG' => $row['DH_TONGTIENHANG'],                                        
                                                                  ...
                                                                  ?>
                <div class="content">
                  <h6 class="mb-10">Đơn hàng trong ngày</h6>
                  ...
                  <?php foreach ($data as $row) : ?>
                    <?php
                         ...
                         global $doanhthu; 
                         $today = date("Y-m-d");                        
                         if ($row['DH_NGAYDAT'] == $today) {
                            $donhang++;    
                            $doanhthu += $row['DH_TONGTIENHANG'] ;                        
                        } else $donhang=0;
                    ?>                   
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <div class="content">
                  ...
                  <?php echo number_format($doanhthu); ?>
                  </h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <?php foreach ($data2 as $row2) : ?>
                  ...
                  <h3 class="text-bold mb-10"><?php echo $tong; ?> </h3>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="icon-card mb-30">
                ...
                <?php foreach ($data3 as $row3) : ?>
                    <?php
                         global $khachhang;
                         if($row3['VT_ID']==1) $khachhang++;  
                    ?>                   

                    <?php endforeach; ?>
                  <h6 class="mb-10">Khách hàng</h6>
                  <h3 class="text-bold mb-10"><?php echo $khachhang; ?> </h3>
            ...
            <div class="col-lg-7">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap justify-content-between">
                  <div class="left">
                    <h6 class="text-medium mb-10">Thông kê</h6>
            ...
            <div class="col-lg-5">
              <div class="card-style mb-30">
                <div class="title d-flex flex-wrap align-items-center justify-content-between">
                  <div class="left">
                    <h6 class="text-medium mb-30">Doanh thu</h6>
                  </div>
                  <div class="right">
                    <div class="select-style-1">
                      <div class="select-position select-sm">
          ...
          <div class="row">
            <div class="col-md-6 order-last order-md-first">
              <div class="copyright text-center text-md-start">
                <p class="text-sm">
                  Luận văn tốt nghiệp ngành hệ thống thông tin
                  </a>
                </p>
              </div>
            </div>
...
<?php                
                                                                          ...
                                                                          while ($row4 = mysqli_fetch_array($result4, MYSQLI_ASSOC)) {
                                                                              $data4[] = array(                                                                                   
                                                                                  'DH_ID' => $row4['DH_ID'],
                                                                                  'DH_NGAYDAT' => $row4['DH_NGAYDAT'], 
                                                                                  'DH_TONGTIENHANG' => $row4['DH_TONGTIENHANG'],                                        
          ...
          datasets: [
            {
              ...
              borderColor: "#365CF5",
              data: [
                500, 800, 750, 880, 940, 880, 900, 770, 920, 890, 976, 1100,
              ],
