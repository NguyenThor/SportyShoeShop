          ...
          <div class="invoice-wrapper">
            <div class="row">
              <div class="col-12">
                ...
                $sql = "select * from donhang a, phuongthucthanhtoan b, diachinhanhang c, tinhtrang d,chitietdonhang e, nguoidung f
                    ...
                    <tbody>
                        <?php foreach ($data as $row) : ?>
                          <tr style="font-size:13px;">
                              <td class="col col-lg-1"><a href="order-details.php?DH_ID=<?php echo $row['DH_ID'] ?>">#<?php echo $row['DH_ID']; ?></a></td>
                              <td class="col col-lg-1"><?php echo $row['ND_TAIKHOAN']; ?> </td>
                              <td class="col col-lg-2"><?php echo $row['PTTT_TEN']; ?></td>
                              <td class="col col-lg-2" style="font-size:12px;text-align: justify;"><b><?php echo $row['DCNH_TEN']; ?></b> | <?php echo $row['DCNH_SDT']; ?> <br>
                                                <?php echo $row['DCNH_DIACHI']; ?>, <?php echo $row['DCNH_XA']; ?>, <?php echo $row['DCNH_HUYEN']; ?>, 
                                                <?php echo $row['DCNH_TINH']; ?>.</td>
                              <td class="col col-lg-2"><?php echo $row['TT_TEN']; ?></td>
                              <td class="col col-lg-1"><?php echo $row['DH_NGAYDAT']; ?></td>
                              <td><?php echo number_format($row['DH_TONGTHANHTOAN']); ?></td>
                              <td class="col col-lg-1" >
                                <a href="order_edit.php?DH_ID=<?php echo $row['DH_ID'] ?>"><i class="fa-solid fa-pen-to-square fa-xl"></i></a>                                
                                <a href="order_delete.php?DH_ID=<?php echo $row['DH_ID'] ?>" style="color:rgb(211, 21, 21);"><i class="fa-solid fa-trash-can fa-xl"></i></a>
                                <a href="order_print.php?DH_ID=<?php echo $row['DH_ID'] ?>" style="color:#000080;"><i class="fa-solid fa-print fa-xl"></i></a>
                              </td>
