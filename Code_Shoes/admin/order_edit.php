            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title d-flex align-items-center flex-wrap">
                  <h2 class="mr-40">Cập nhật đơn hàng</h2>                     
                </div>
              </div>
              <!-- end col -->
              <div class="col-md-6">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <?php
                    ...
                    $DH_ID = $_GET['DH_ID'];
                    $sqlSelect = "select * from `donhang` a, tinhtrang b where a.DH_ID = '$DH_ID' and b.TT_ID=a.TT_ID ";
                ...
                <form action="order_edit1.php" name="frmCreate" method="post"  class="form">
                                                        <table class="table table-light">
                                                            <tr>    <input type="hidden" name="DH_ID" id="DH_ID" class="form-control" value="<?php echo $Row['DH_ID'] ?>" />
                                                                <td>Trạng thái đơn hàng</td>
                                                                <td>
                                                                  <select name="TT_ID" class="form-control form-select">
                                                                              <option value="<?php echo $Row['TT_ID']; ?>"><?php echo $Row['TT_TEN']; ?> </option>                   

                                                                              <?php foreach ($data0 as $row0) : ?>    
                                                                                  <option value="<?php echo $row0['TT_ID']; ?>"><?php echo $row0['TT_TEN']; ?></option>                   
                                                                              <?php endforeach; ?>
                                                                  </select>
                                                                </td>                                                            </tr> 
