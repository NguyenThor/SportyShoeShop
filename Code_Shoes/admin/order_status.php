            ...
            ?> 
                    ...
                    <?php foreach ($data as $row) : ?>
                          <tr style="font-size:13px;">
                              ...
                              <td class="col col-lg-1" style="font-size:20px;">
                                <a href="order_edit.php?DH_ID=<?php echo $row['DH_ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>                                
                                <a href="order_delete.php?DH_ID=<?php echo $row['DH_ID'] ?>" style="color:rgb(211, 21, 21);"><i class="fa-solid fa-trash-can"></i></a>
                              </td>
