            ...
            <div class="row align-items-center">
              <div class="col-md-6">
                <div class="title d-flex align-items-center flex-wrap">
                  <h2 class="mr-40">Cập nhật thương hiệu</h2>
          ...
          <div class="invoice-wrapper">
            <div class="row">
              <div class="col-12">
                ...
                <form action="product_add_color1.php?SP_ID=<?php echo $SP_ID ?>" name="frmCreate" method="post"  class="form">
                                                        <table class="table table-light">
                                                            <tr>
                                                                <td>Tên màu sắc</td>
                                                                <input type="hidden" name="SP_ID" id="SP_ID" class="form-control" value="<?php echo $SP_ID ?>" />
                                                                <input type="hidden" name="MS_ID" id="MS_ID" class="form-control" value="<?php echo $row2['MS_ID'] ?>" />
                                                                <td>
                                                                            <select name="MS_ID" class="form-control form-select ">

                                                                                        <?php foreach ($data2 as $row2) : ?>    
                                                                                            <option value="<?php echo $row2['MS_ID']; ?>"><?php echo $row2['MS_TEN']; ?></option>                   
                                                                                        <?php endforeach; ?>
                                                                            </select>
                                                                </td>
                                                            </tr>                                                            
