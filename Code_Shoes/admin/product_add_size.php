          ...
          <div class="title-wrapper pt-30">
            ...
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">               
                                                ...
                                                <form name="frmCreate" method="post" action="size_add.php" class="form">
                                                        <table class="table table-light">
                                                            <tr>
                                                                <td>Tên kích cỡ</td>
                                                                <td><input type="text" name="KC_TEN" id="KC_TEN" class="form-control" /></td>
                                                            </tr>                                                            
                                                        </table>
          ...
          <div class="invoice-wrapper">
            <div class="row">
              <div class="col-12">
                ...
                <form action="product_add_size1.php?SP_ID=<?php echo $SP_ID ?>" name="frmCreate" method="post"  class="form">
                                                        <table class="table table-light">
                                                            <tr>
                                                                <td>Tên kích cỡ</td>
                                                                <input type="hidden" name="SP_ID" id="SP_ID" class="form-control" value="<?php echo $SP_ID ?>" />
                                                                <input type="hidden" name="KC_ID" id="KC_ID" class="form-control" value="<?php echo $row2['KC_ID'] ?>" />
                                                                <td>
                                                                            <select name="KC_ID" class="form-control form-select ">
