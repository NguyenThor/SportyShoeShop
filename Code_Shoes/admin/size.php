                        ...
                        <?php foreach ($data as $row) : ?>
                          <tr>
                              ...
                              <td style="font-size:20px;">
                                <a href="size_edit.php?KC_ID=<?php echo $row['KC_ID'] ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                 &nbsp;&nbsp;
                                <a  href="size_delete.php?KC_ID=<?php echo $row['KC_ID'] ?>" style="color:rgb(211, 21, 21);"><i class="fa-solid fa-trash-can"></i></a>
                              </td>
                          </tr>                         
                        <?php endforeach; ?>
                    </tbody>
