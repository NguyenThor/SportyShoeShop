            ...
            <div class="row">
              <div class="col-12">
                ...
                <?php
                    ...
                    $KC_ID = $_GET['KC_ID'];
                    $sqlSelect = "select * from `kichco` where KC_ID = '$KC_ID' ";
                ...
                <form action="size_edit1.php" name="frmCreate" method="post"  class="form">
                                                        <table class="table table-light">
                                                            <tr>
                                                                <td>Tên kích cỡ</td>
                                                                <input type="hidden" name="KC_ID" id="KC_ID" class="form-control" value="<?php echo $Row['KC_ID'] ?>" />
                                                                <td><input type="text" name="KC_TEN" id="KC_TEN" class="form-control" value="<?php echo $Row['KC_TEN'] ?>" /></td>
                                                            </tr>                                                            
                                                        </table>
                                                        <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button> &nbsp;&nbsp;
