            ...
            <div class="row">
              <div class="col-12">
                ...
                <?php
                    ...
                    $NCC_ID = $_GET['NCC_ID'];
                    $sqlSelect = "select * from `nhacungcap` where NCC_ID = '$NCC_ID' ";
                ...
                <form action="supplier_edit1.php" name="frmCreate" method="post"  class="form">
                                                        <table class="table table-light">
                                                        <tr>    <input type="hidden" name="NCC_ID" id="NCC_ID" class="form-control" value="<?php echo $Row['NCC_ID'] ?>" />
                                                                <td>Tên nhà cung cấp</td>
                                                                <td><input type="text" name="NCC_TEN" id="NCC_TEN" class="form-control" value="<?php echo $Row['NCC_TEN'] ?>" /></td>
                                                            </tr> 
                                                            <tr>
                                                                <td>SDT</td>
                                                                <td><input type="text" name="NCC_SDT" id="NCC_SDT" class="form-control" value="<?php echo $Row['NCC_SDT'] ?>"/></td>
                                                            </tr>
                                                            <tr>
                                                                <td>Email</td>
                                                                <td><input type="text" name="NCC_EMAIL" id="NCC_EMAIL" class="form-control" value="<?php echo $Row['NCC_EMAIL'] ?>"/></td>
                                                            </tr> 
                                                            <tr>
                                                                <td>Địa chỉ</td>
                                                                <td><input type="text" name="NCC_DIACHI" id="NCC_DIACHI" class="form-control" value="<?php echo $Row['NCC_DIACHI'] ?>" /></td>
                                                            </tr>                                                            
                                                        </table>
                                                        <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button> &nbsp;&nbsp;
