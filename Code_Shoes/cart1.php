    ...
    <body >
        ...
        <!-- cart item area start -->
         <?php
                                ...
                                ?> 
        <form action="oder-save.php" method="post">                        
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                <?php foreach ($data as $row) : ?>
                                    <tr>
                                        ...
                                        <a href="single-product.php?SP_ID=<?php echo $row['SP_ID'];?>"><?php echo $row['SP_TEN']; ?></a> <input type="hidden" name="SP_ID" value="<?php echo $row['SP_ID'];?>">
                                        </td>
                                        <td class="edit">
                                            <a href="#"><?php echo number_format ($row['SP_GIA']); ?></a> <input type="hidden" name="SP_GIA" value="<?php echo number_format ($row['SP_GIA']);?>">
                                        </td>
                                        <td class="move-wishlist">
                                            <a href="#"><?php echo $row['KC_TEN'];?></a><input type="hidden" name="KC_ID" value="<?php echo $row['KC_ID'];?>">
                                        </td>
                                        <td class="unit-price">
                                            <span><?php echo $row['MS_TEN'];?></span><input type="hidden" name="MS_ID" value="<?php echo $row['MS_ID'];?>">
                                        </td>
                            ...
                            <div >
                                <div class="continue-shopping">
                                    <a href="khachhang_index.php" class="btn btn-primary">TIẾP TỤC MUA SẮM</a>
                                </div>
                                <div class="shopping-cart-left">
                                    <a href="cart-deleteall.php?ND_ID=<?php echo $row['ND_ID']; ?>" class="btn btn-danger" >XÓA GIỎ HÀNG</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="discount-code">
                            ...
                            <?php
                                ...
                                while ($rowPTTT = mysqli_fetch_array($resultPTTT, MYSQLI_ASSOC)) {
                                    $dataPTTT[] = array(
                                        'PTTT_ID' => $rowPTTT['PTTT_ID'],
                                        'PTTT_TEN' => $rowPTTT['PTTT_TEN'],
                                
                                    );
                                }
                            ?>                             
                                <select name="PTTT_ID" id="PTTT_ID" class="form-control" >
                                    <option value="">--Chọn--</option>
                                        <?php foreach ($dataPTTT as $rowPTTT) : ?>
                            
                                    <option name="PTTT" value="<?php echo $rowPTTT['PTTT_ID'];?>">
                                ...
                                <div class="form-name">
                                        <h3><label class="form-label"> Ghi chú </label></h3>
                                        <textarea name="DH_GHICHU" class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>                                          
                    ...
                    <div class="col-sm-4">
                        <div class="estimate-shipping">
                            ...
                            $sql1 = "select * from diachinhanhang where DCNH_MA = '$DCNH_MA'";
                        ...
                        while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)) {
                            $data1[] = array(
                                ...
                                'DCNH_MA' => $row1['DCNH_MA'],
                                'DCNH_TEN' => $row1['DCNH_TEN'],
                                'DCNH_SDT' => $row1['DCNH_SDT'],
                                'DCNH_DIACHI' => $row1['DCNH_DIACHI'],
                                'DCNH_TINH' => $row1['DCNH_TINH'],
                                'DCNH_HUYEN' => $row1['DCNH_HUYEN'],
                                'DCNH_XA' => $row1['DCNH_XA'],
                                'ND_ID' => $row1['ND_ID'],
                    ...
                    <h3 style="font-size:15px;">
                        ...
                        <?php 
                                            ...
                                            echo '<input type="hidden" name="DCNH_MA" value="'.$DCNH_MA.'"> <div>
                                            <b>'.$row1['DCNH_TEN'].'</b> | '.$row1['DCNH_SDT'].
                                            '<a class="btn"  href="address.php" style="color:red;font-size:13px;margin-left: 45px;">Thay đổi địa chỉ</a></div>     
                                            <div>'.$row1['DCNH_DIACHI'].','.$row1['DCNH_XA'].','.$row1['DCNH_HUYEN'].','.$row1['DCNH_TINH']
                    ...
                    <div class="col-sm-4">
                        <div class="totals">                             
                            <?php foreach ($data as $row) : ?><p>Tổng tiền hàng <span><?php echo number_format ($thanhtien) ;?></span></p><input name="DH_TONGTIENHANG" type="hidden" value="<?php echo ($thanhtien) ;?>">
                                ...
                                <h3>Tổng thanh toán <span><p style="font-size:20px;" name="DH_TONGTHANHTOAN"><?php echo number_format($thanhtien+30000);?></span></p></h3>
                                    ...
                                    <?php endforeach; ?>
                                <div class="shopping-cart-left">
                                    <input class="btn btn-danger" type="submit" value="ĐẶT HÀNG"></input>
                                </div>  
