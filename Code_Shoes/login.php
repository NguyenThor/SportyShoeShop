            ...
            <div class="top-link">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="dashboard" style="padding-top:15px;">
                            <span style="color: #fff;"><a href="register.php" style="color: #fff;"><i class="fa-regular fa-user" ></i> Đăng ký</a>&ensp;&ensp;|&ensp;&ensp;<a href="login.php" style="color: #fff;"><i class="fa-solid fa-right-to-bracket"></i> Đăng nhập</a></span>                              
                        ...
                        <div class="login">
                            <div class="login-form-container">
                                <div class="login-text">
                                    <h2>Đăng nhập</h2>
                                    <span>Vui lòng đăng nhập bằng cách sử dụng chi tiết tài khoản dưới đây.</span>
                                </div>
                                <div class="login-form">
                                    <form action="dangnhap.php" method="post" >
                                        <input type="text" name="ND_TAIKHOAN" placeholder="Tài khoản">
                                        <input type="password" name="ND_MATKHAU" placeholder="Mật khẩu">
                                        <div class="button-box">
                                            <div class="login-toggle-btn">
                                                <input type="checkbox" id="remember">
                                                <label for="remember">Giữ đăng nhập</label>
