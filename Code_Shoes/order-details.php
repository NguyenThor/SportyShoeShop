                        ...
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                        <tr>
                                            <th class="cart-item-img">Mã đơn #<?php echo $row['DH_ID'];?></th>
                                    ...
                                    <tbody class="text-center">
                                        ...
                                        <tr>
                                            ...
                                            <td class="edit">
                                                <a href="#"><?php echo number_format ($row['SP_GIA']); ?></a> <input type="hidden" name="SP_GIA" value="<?php echo $row['SP_GIA'];?>">
                                            </td>
                                ...
                                <div class="col-sm-5" style="margin-left:650px;">
                                        <div class="totals"> 
                                            <p>Tổng tiền hàng <span><?php echo number_format ($thanhtien) ;?></span></p><input name="DH_TONGTIENHANG" type="hidden" value="<?php echo number_format ($thanhtien) ;?>">
                                            ...
                                            <h3>Tổng thanh toán <span><p style="font-size:20px;" name="DH_TONGTHANHTOAN"><?php echo number_format ($thanhtien+30000);?></span></p></h3>
                                                <input name="DH_TONGTHANHTOAN" type="hidden" value="<?php echo number_format ($thanhtien+30000) ;?>">
                                            <div class="shopping-cart-left">
                                                <a href="order_delete.php?DH_ID=<?php echo $row['DH_ID']; ?>" class="btn btn-danger" >HỦY ĐƠN HÀNG</a>
                                            </div>                           
                                        </div>
                                 </div>    
                            </div>
