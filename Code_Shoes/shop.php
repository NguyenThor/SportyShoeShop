                                            ...
                                            <div class="single-product">
                                                ...
                                                <div class="product-img">
                                                    <a href="single-product.php?SP_ID=<?php echo $row['SP_ID'];?>">
                                                        ...
                                                        <img src="img/product/<?php echo $row['SP_HINH2']; ?>" alt="" class="secondary-img">
                                                    </a>
                                                </div>
                                                <div class="actions">
                                                    <a href="single-product.php?SP_ID=<?php echo $row['SP_ID'];?>"><button type="submit" class="cart-btn" title="Add to cart">Thêm giỏ hàng</button></a>
                                                ...
                                                <div class="product-price">
                                                    ...
                                                    <div class="price-rating">
                                                        <span><?php echo number_format ($row['SP_GIA']); ?> VND</span>
                                                        <div class="ratings">
